...
$fflLang = &$GLOBALS['TL_LANG']['FFL'];
$fflLang['multifileupload'][0] = 'File-Upload (Multi File Upload)';
$fflLang['multifileupload'][1] = 'An input field for transferring several local files with drag & drop support to the server.';
