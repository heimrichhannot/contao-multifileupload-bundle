...
namespace HeimrichHannot\MultiFileUploadBundle\Tests\ContaoManager;
...
use HeimrichHannot\MultiFileUploadBundle\ContaoManager\Plugin;
...
class PluginTest extends ContaoTestCase
{
    ...
    public function testGetBundles()
    {
        ...
        static::assertEquals(HeimrichHannotContaoMultiFileUploadBundle::class, $bundles[0]->getName());
